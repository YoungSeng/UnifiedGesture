...
class GaussianDiffusion:
    ...
    def p_sample_with_grad(
        ...
        return {"sample": sample, "pred_xstart": out["pred_xstart"]}        # 20230428
    ...
    def p_sample_loop_progressive(
        ...
        indices = list(range(num_timesteps - skip_timesteps))[::-1]
        ...
        for i in indices:
            ...
            if not cond_fn_with_grad:
                with th.no_grad():
                    # sample_fn = self.p_sample_with_grad if cond_fn_with_grad else self.p_sample       # 20230429
